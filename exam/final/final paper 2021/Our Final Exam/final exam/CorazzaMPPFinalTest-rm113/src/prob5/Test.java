...
public class Test {
	...
	public static void testStrings() {
		 ...
		 List<Pair<String, String>> pairList = AllPairs.allIncreasingPairs(strs);
		 System.out.println(pairList);
	...
	public static void testLocalDates() {
		 ...
		 //uncomment when ready
		 List<Pair<LocalDate, LocalDate>> pairList = AllPairs.allIncreasingPairs(dates);
		  System.out.println(pairList);
	...
	public static void testEmployees() {		
		 ...
		 List<Pair<Employee, Employee>> pairList = AllPairs.allIncreasingPairs(emps);
		  System.out.println(pairList);
