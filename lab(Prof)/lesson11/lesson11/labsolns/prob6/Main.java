package lesson11.labsolns.prob6;
import java.util.*;
...
//		test6();
	...
	//contains2 doesn't work here; T = Manager
	...
	//contains3 doesn't work here; T = Account
	...
	//contains3 doesn't work here; T = Employee
	public static void test6() {
		...
		boolean foundIt = Main.contains4(list, emp, 
			(Employee e, Person p) -> e.getName().equals(p.getName()));
		System.out.println(foundIt);		
	}
